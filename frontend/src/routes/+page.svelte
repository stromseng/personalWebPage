...
<ContentBody>
    <div class="mt-12 mb-24 md:mb-48 sm:flex sm:flex-col-2">
        <div class="w-full">
            <div class="">
        ...
        <div class="w-[400px] justify-normal content-normal hidden md:flex">
            <LogoSvg />
        </div>
    </div>

    <!-- SVG Logo -->
    <div class="mb-24 w-full justify-normal content-normal flex md:hidden">
        <LogoSvg />
    </div>
    ...
    <div class="w-full gap-2 prose mb-16">
        ...
        <p class="text-l">
            I'm a {new Date().getFullYear() -
                2002 -
                (new Date() < new Date(new Date().getFullYear(), 3, 19)
                    ? 1
                    : 0)} year old Informatics student from Oslo, Norway. I'm currently
            in the first year of my master's degree at the Norwegian University of
            Technology and Science. I'm passionate about technology and I love to
            learn new things. I'm also a big fan of open source software and I try
            to contribute to open source projects whenever I can. You can read more
